...
namespace FirstPersonShooter.Profiling
{
    ...
    {
        private ILogger<GameProfiler> _logger;
        ...
        {
            _logger = Services.GetService<LoggingManager>().GetLogger<GameProfiler>();
            ...
            while (Game.IsRunning)
            {
                ...
                // _logger.Log(new Reading
                // {
                //     Label = TestFactory.Label,
                //     FPS = (int)GameProfiler.Game.UpdateTime.FramePerSecond
                // });
